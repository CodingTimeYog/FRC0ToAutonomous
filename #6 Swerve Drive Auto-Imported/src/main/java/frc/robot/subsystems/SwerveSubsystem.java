...
public class SwerveSubsystem extends SubsystemBase {
    ...
    private SwerveModulePosition[] myPositions = {frontLeft.getSwerveModulePosition(), frontRight.getSwerveModulePosition(), 
    ...
    public void resetOdometry(Pose2d pose) {
        odometer.resetPosition(gyro.getRotation2d(), myPositions , pose );
    }

    @Override
    public void periodic() {
        odometer.update(getRotation2d(), myPositions);
